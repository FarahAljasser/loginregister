...
public class Login extends AppCompatActivity {
    TextInputEditText  textInputLayoutEmail,textInputLayoutPassword;
    Button buttonLogin;
                ...
                if(!email.equals("") && !password.equals("")){
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            field[0] = "email";
                            field[1] = "password";
                            PutData putData = new PutData("http://localhost/dashboard/LogIn-SignUp/login.php", "POST", field, data);
                            if (putData.startPut()) {
